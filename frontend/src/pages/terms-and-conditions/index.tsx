        ...
        <CardContent>
          <Box sx={{ maxWidth: '800px', mx: 'auto', p: 4 }}>
            ...
            <Typography variant='body1' sx={{ mb: 4 }}>
              These terms and conditions outline the rules and regulations for the use of Simppel LLC's Website, located
              at https://app.simppel.com.
            </Typography>
            <Typography variant='body1' sx={{ mb: 4 }}>
              By accessing this website we assume you accept these terms and conditions. Do not continue to use Simppel
            ...
            <Typography variant='body1' sx={{ mb: 4 }}>
              ...
              provision of the Company's stated services, in accordance with and subject to, prevailing law of bg. Any
              use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they,
            ...
            <Typography variant='body1' sx={{ mb: 4 }}>
              We employ the use of cookies. By accessing Simppel, you agreed to use cookies in agreement with the
              Simppel LLC's Privacy Policy.
            </Typography>
            <Typography variant='body1' sx={{ mb: 4 }}>
            ...
            <Typography variant='body1' sx={{ mb: 4 }}>
              Unless otherwise stated, Simppel LLC and/or its licensors own the intellectual property rights for all
              material on Simppel. All intellectual property rights are reserved. You may access this from Simppel for
            ...
            <ul>
              <li>Republish material from Simppel</li>
              <li>Sell, rent or sub-license material from Simppel</li>
              <li>Reproduce, duplicate or copy material from Simppel</li>
              <li>Redistribute content from Simppel</li>
            </ul>
            <Typography variant='body1' sx={{ mb: 4 }}>
            ...
            <Typography variant='body1' sx={{ mb: 4 }}>
              ...
              certain areas of the website. Simppel LLC does not filter, edit, publish or review Comments prior to their
              presence on the website. Comments do not reflect the views and opinions of Simppel LLC,its agents and/or
              affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
              the extent permitted by applicable laws, Simppel LLC shall not be liable for the Comments or for any
              liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or
              appearance of the Comments on this website.
            </Typography>
            <Typography variant='body1' sx={{ mb: 4 }}>
              Simppel LLC reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <Typography variant='body1' sx={{ mb: 4 }}>
              You hereby grant Simppel LLC a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <Typography variant='body1' sx={{ mb: 4 }}>
              ...
              absence of Simppel LLC; and (d) the link is in the context of general resource information.
            </Typography>
            <Typography variant='body1' sx={{ mb: 4 }}>
            ...
            <Typography variant='body1' sx={{ mb: 4 }}>
              ...
              website, you must inform us by sending an e-mail to Simppel LLC. Please include your name, your
            ...
            <Typography variant='body1' sx={{ mb: 4 }}>
              No use of Simppel LLC's logo or other artwork will be allowed for linking absent a trademark license
              agreement.
            </Typography>
            <Typography variant='h4' sx={{ mb: 2 }}>
              4. iFrames
            ...
            <Typography component='ul' sx={{ mb: 4 }}>
              <li>
                Acceptance of Terms: By accessing and using our app/website, you agree to comply with these Terms of
                Service. Please ensure you have also read and agreed to TikTok's Terms of Service for using their API.
              </li>
              <li>
                Use of TikTok API: Our app/website utilizes the TikTok API to display TikTok posts. By using our
                app/website, you acknowledge and agree to abide by TikTok's Terms of Service and Developer Agreement.
              </li>
              <li>
                Content Displayed: Our app/website provides a platform to view TikTok posts obtained through the TikTok
                API. The displayed content belongs to the respective TikTok creators, and we do not claim ownership or
                endorse any specific TikTok post.
              </li>
              <li>
                User Obligations: You are solely responsible for your use of the TikTok API and the displayed TikTok
                posts through our app/website. You agree not to misuse or modify the TikTok API data, and to comply with
                any usage restrictions or limitations imposed by TikTok.
              </li>
              <li>
                Intellectual Property: All content and intellectual property related to the TikTok API and TikTok
                platform belong to TikTok and its licensors. You may not use, reproduce, or distribute any TikTok
                content or API-related materials without proper authorization.
              </li>
              <li>
                Disclaimers and Limitations: We strive to provide accurate and reliable information through our
                app/website, but we make no guarantees regarding the completeness, accuracy, or availability of the
                TikTok API or the information obtained from it. We shall not be liable for any damages or losses arising
                from your use of the TikTok API or any reliance on its content.
              </li>
            </Typography>
          </Box>
        </CardContent>
...
TermsAndConditionsPage.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>
